...
namespace RFD.API.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class ReptilesTestController : ControllerBase
    {
        ...
        public ReptilesTestController(ITableStorageManager storageManager, ISeedReptileData seedReptileData, IReptileManager reptileManager)
        {
