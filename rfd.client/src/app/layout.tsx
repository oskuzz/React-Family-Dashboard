    ...
    <html lang="en">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`} >
        <div className="flex h-screen flex-col md:flex-row md:overflow-hidden">
          <div className="w-full flex-none md:w-64" style={{backgroundColor: 'var(--theme-color-gray)'}}>
            < SideNav />
          </div>
          <div className="flex-grow p-6 md:overflow-y-auto md:p-12" style={{backgroundColor: 'var(--theme-color-lightgray)'}}>{children}</div>
        </div>
      </body>
    </html>
  );
